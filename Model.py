...
#from the paper, the input is 84*84
...
class MModel():
    def __init__(self,numActions,img_rows,img_cols,img_channels):
        ...
        # these is no max pooling when the stride size is big compared to input size. 
        adam = Adam(lr=1e-4)
    ...
    def predict(self,imageStack):
        ...
        return q
    def train(self,x,y): # train on batches is more personalized. 
